...
# ADBYBY Plus +
svn export https://github.com/immortalwrt/luci/branches/openwrt-23.05/applications/luci-app-adbyby-plus feeds/luci/applications/luci-app-adbyby-plus
ln -sf ../../../feeds/luci/applications/luci-app-adbyby-plus ./package/feeds/luci/luci-app-adbyby-plus
svn export https://github.com/immortalwrt/packages/branches/openwrt-23.05/net/adbyby package/new/adbyby

# iKoolproxy
git clone https://github.com/yaof-project/luci-app-ikoolproxy.git package/new/luci-app-ikoolproxy

# turboacc
#svn export https://github.com/immortalwrt/luci/branches/openwrt-23.05/applications/luci-app-turboacc feeds/luci/applications/luci-app-turboacc
...
svn export https://github.com/immortalwrt/packages/branches/openwrt-23.05/net/brook package/new/brook
svn export https://github.com/immortalwrt/packages/branches/openwrt-23.05/net/chinadns-ng package/new/chinadns-ng
svn export https://github.com/immortalwrt/packages/branches/openwrt-23.05/net/trojan-go package/new/trojan-go
svn export https://github.com/immortalwrt/packages/branches/openwrt-23.05/net/trojan-plus package/new/trojan-plus
svn export https://github.com/immortalwrt/packages/branches/openwrt-23.05/net/v2ray-core package/new/v2ray-core
...
svn export https://github.com/immortalwrt/packages/branches/openwrt-23.05/net/dns2socks package/new/dns2socks
svn export https://github.com/immortalwrt/packages/branches/openwrt-23.05/net/ipt2socks package/new/ipt2socks
# Fix hash issue
...
svn export https://github.com/immortalwrt/packages/branches/openwrt-23.05/net/kcptun package/new/kcptun
svn export https://github.com/immortalwrt/packages/branches/openwrt-23.05/net/microsocks package/new/microsocks
svn export https://github.com/immortalwrt/packages/branches/openwrt-23.05/net/pdnsd-alt package/new/pdnsd-alt
svn export https://github.com/immortalwrt/packages/branches/openwrt-23.05/net/redsocks2 package/new/redsocks2
svn export https://github.com/immortalwrt/packages/branches/openwrt-23.05/net/shadowsocks-libev package/new/shadowsocks-libev
...
svn export https://github.com/immortalwrt/luci/branches/openwrt-23.05/applications/luci-app-upnp feeds/luci/applications/luci-app-upnp
