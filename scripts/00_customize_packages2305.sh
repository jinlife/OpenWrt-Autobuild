...
# fullconenat-nft
cp -rfv ../immortalwrt/package/network/utils/fullconenat-nft package/network/utils/
# libnftnl
rm -rfv ./package/libs/libnftnl
cp -rfv ../immortalwrt/package/libs/libnftnl package/libs/
# nftables
rm -rfv ./package/network/utils/nftables/
cp -rfv ../immortalwrt/package/network/utils/nftables package/network/utils/
# firewall4
rm -rfv ./package/network/config/firewall4
cp -rfv ../immortalwrt/package/network/config/firewall4 package/network/config/
# patch luci
